...
namespace PRIS.Controllers
{
    public class Companies1Controller : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "CompanyId,CompanyName,CompanyWebsite,CompanyInformation,Password,CompanyAddress,CompanyEmail,CompanyPhoneNo,CompanyLogo,CompanyBenefits")] Company company)
        {
